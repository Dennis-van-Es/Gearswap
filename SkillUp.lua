...
user_settings = {
    user_spells = {
        ...
        Geomancy = T{"Indi-Poison","Indi-Voidance","Indi-Precision","Indi-Regen","Indi-Focus", "Indi-Barrier", "Indi-Refresh"},
        Enhancing = T{"Barfire", "Barwater", "Barblizzard", "Baraero", "Barstone", "Barthunder", "Barpoison", "Barsleep"},
        Ninjutsu = T{},
        Singing = T{"Victory March","Advancing March","Valor Minuet V"},
        Blue = T{},
        Summoning = T{"Carbuncle", "Shiva", "Titan", "Garuda", "Ramuh", "Cait Sith", "Leviathan", "Ifrit"}
    },
    save_settings = false} --change this to true if you wish to save the last position of your skillup window
sets.brd = {
    wind_inst = {
        range="Homestead Flute"},--put your wind instrument here
    string_inst = {
